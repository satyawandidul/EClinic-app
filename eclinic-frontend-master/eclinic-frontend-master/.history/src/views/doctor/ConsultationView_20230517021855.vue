                  ...
                  <v-row>
                    ...
                    <v-col cols="12" md="4">
                      <v-select
                        label="Discount"
                        :items="discountList"
                        v-model="visit.discount"
                      ></v-select>
                    </v-col>
                    <v-col cols="12" md="4">
                      <v-text-field
                        label="Next visit in"
                        v-model="visit.apptDays"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" md="4">
                      <v-select
                        :items="yesNoList"
                        label="Is a Testimonial?"
                        v-model="visit.testimonial"
                      ></v-select>
                    </v-col>
                  </v-row>
                </v-form>
              ...
              <v-card-text>
                ...
                >
                  <v-row>
                    ...
                    <v-col cols="12" lg="1">
                      <v-text-field
                        v-model="selectedMedicine.morningDose"
                        label="Morning"
                    ...
                    <v-col cols="12" lg="1">
                      <v-text-field
                        v-model="selectedMedicine.afternoonDose"
                        label="Noon"
                        :rules="[rules.required, rules.Number]"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" lg="1">
                      <v-text-field
                        v-model="selectedMedicine.eveningDose"
                        label="Evening"
                        :rules="[rules.required, rules.Number]"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" lg="1">
                      <v-text-field
                        v-model="selectedMedicine.nightDose"
                        label="Night"
                        :rules="[rules.required, rules.Number]"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" lg="3">
                      <v-textarea
                        ...
                        auto-grow
                        label="Remark"
                        v-model="selectedMedicine.remark"
                      ></v-textarea>
                    </v-col>
                    <v-col cols="12" lg="1">
                      <v-text-field
                        v-model="selectedMedicine.days"
                        label="Days"
                        :rules="[rules.NonZero]"
                        ref="daysField"
                      ></v-text-field>
