...
export default new Vuex.Store({
  ...
  state: {
    ...
    doctorRoutes: [
      { icon: 'mdi-view-dashboard-outline', title: 'ConsultationView', to: '/doctor/ConsultationView' },
      { icon: 'mdi-view-dashboard', title: 'Dashboard', to: '/doctor/Dash' },
      { icon: 'mdi-sofa', title: 'WaitingRoom', to: '/admin/dashboard' },
