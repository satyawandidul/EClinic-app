...
export default new Vuex.Store({
  ...
  state: {
    ...
    adminRoutes: [
      { icon: 'mdi-view-dashboard-outline', title: 'Admin Dashboard', to: '/admin/dashboard' },
    ...
    doctorRoutes: [
      { icon: 'mdi-view-dashboard', title: 'ConsultationView', to: '/admin/dashboard' },
      { icon: 'mdi-view-dashboard', title: 'Dashboard', to: '/admin/dashboard' },
      { icon: 'mdi-view-dashboard', title: 'WaitingRoom', to: '/admin/dashboard' },
