...
export default {
  ...
  data: () => ({
    items: [],
    stock: [{ medicineName: "Vix", price: "1025", shortCode: "pune" },
    { medicineName: "Dolo", price: "100", shortCode: "Beed" },
    { medicineName: "Vix", price: "1025", shortCode: "Beed" },
    ...
    headers: [
      { text: "Barcode", align: "start", value: "barcode", align: "shortCode" },
      { text: "Medicine Name", value: "medicineName", align: "shortCode" },
      { text: "Price", value: "price", align: "shortCode" },
