...
export default {
  ...
  data: () => ({
    items: [],
    stock: [{ medicineName: "Vix", price: "1025", shortCode: "pune", isInTransit: "Yes", Isavaible: "yes" },
    { medicineName: "Dolo", price: "100", shortCode: "Beed", isInTransit: "Yes", Isavaible: "yes" },
    { medicineName: "Vix", price: "1025", shortCode: "sambhajinagar", Isavaible: "No", IsInTransit: "Yes" },
