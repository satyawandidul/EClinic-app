...
export default {
  ...
  data: () => ({
    items: [],
    stock: [{ medicineName: "Barcode", price: "1025", location: "pune" },
    { medicineName: "Medicine Name", price: "100", location: "Beed" },
    { medicineName: "Barcode", price: "1025", location: "Beed" },
    ...
    headers: [
      { text: "Barcode", align: "start", value: "barcode", align: "location" },
      { text: "Medicine Name", value: "medicineName", align: "location" },
      { text: "Price", value: "price", align: "location" },
